...
description: "Робимо з б’юті-кейса кабінку з монстром, як у фільмі Хижа у лісі"
...
---
## Робимо з б’юті-кейса кабінку з монстром, як у фільмі *Хижа у лісі*
...
Спочатку я хотів просто подарувати його таким, як він є, але потім святковий настрій Хелловіна взяв гору, і я переконав себе, що це точна копія кабінки для монстра з фільму *Хижа у лісі*.

Добре. Тільки якого монстра?

### Створення персонажа у стилі Хижі у лісі

Я витратив деякий час на те, щоб ми з ШІ (а саме, з чатом GPT) змогли створити неназваного у фільмі персонажа, який буде мешкати у б’юті-кабінці.
...
Референс для ванної кімнати — ванна кімната леді Дімітреску з гри *Обитель зла: Село*.
...
Історія з гламурною Хель із кабіни матиме продовження, і вона з’явиться в кількох моїх наступних роботах\! 😉
